...
import {IInitializableXToken} from './IInitializableXToken.sol';

interface IXToken is IERC20, IScaledBalanceToken, IInitializableXToken {
  /**
  ...
  /**
   * @dev Invoked to execute actions on the xToken side after a repayment.
