...
contract ProtocolFlowTest is ProtocolTestUtils {
    ...
    function testBasicProtocolFlowWithUSDC() public {
        ...
        expectedRedeemAmount = expectedRedeemAmount + collateralAmount / 2;
    ...
    function testProtocolFlow_PriceIncrease() public {
        ...
        // Complete cycle with 10% price increase
        ...
        expectedRedeemAmount = expectedRedeemAmount + collateralAmount;
        
        // Verify user1's redemption amount after price increase
        uint256 actualRedeemAmount = reserveToken.balanceOf(user1) - user1ReserveBefore;
        
        // User should have received more reserves back due to price increase
        assertGt(actualRedeemAmount, totalAmount, "User1 should receive more reserves after price increase");
        assertApproxEqRel(actualRedeemAmount, expectedRedeemAmount, 0.03e18, "Redeemed amount should match expected at higher price");
    ...
    function testProtocolFlow_PriceDecrease() public {
        ...
        assertLt(actualRedeemAmount, totalAmount, "User1 should receive fewer reserves after price decrease");
        assertApproxEqRel(actualRedeemAmount, expectedRedeemAmount, 0.03e18, "Redeemed amount should match expected at lower price");
    ...
    function testProtocolFlowWithDAI() public {
        ...
        uint256 redeemedAmount = reserveToken.balanceOf(user1) - user1ReserveBefore;
        assertGt(redeemedAmount, 0, "User1 should have received reserves back");
        assertApproxEqRel(redeemedAmount, expectedRedeemAmount, 0.03e18, "Redeemed amount should match expected with 18 decimal token");
    }
