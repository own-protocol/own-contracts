...
contract ProtocolFlowTest is ProtocolTestUtils {
    ...
    uint256 constant PRICE_INCREASE = 150 * 1e18; // $150.00 per asset
    ...
    function testBasicProtocolFlowWithUSDC() public {
        ...
        assertApproxEqRel(assetToken.balanceOf(user1), expectedUser1Assets, 0.01e18, "User1 asset balance incorrect after initial mint");
        ...
        assertApproxEqRel(assetToken.balanceOf(user2), expectedUser2Assets, 0.01e18, "User2 asset balance incorrect");
        
        // Verify user1's remaining assets and redeemed reserves
        assertApproxEqRel(assetToken.balanceOf(user1), user1TokensBefore / 2, 0.01e18, "User1 remaining asset balance incorrect");
        ...
        assertApproxEqRel(redeemedAmount, expectedRedeemAmount, 0.05e18, "Redeemed amount should match expected");
    }
    ...
    function testProtocolFlow_PriceIncrease() public {
        ...
        assertApproxEqRel(actualRedeemAmount, expectedRedeemAmount, 0.05e18, "Redeemed amount should match expected at higher price");
    ...
    function testProtocolFlow_PriceDecrease() public {
        ...
        assertApproxEqRel(actualRedeemAmount, expectedRedeemAmount, 0.05e18, "Redeemed amount should match expected at lower price");
    ...
    function testProtocolFlowWithDAI() public {
        ...
        uint256 expectedUser1Assets = getExpectedAssetAmount(depositAmount, INITIAL_PRICE);
        assertApproxEqRel(assetToken.balanceOf(user1), expectedUser1Assets, 0.01e18, "User1 asset balance incorrect with 18 decimal token");
        ...
        uint256 redeemedAmount = reserveToken.balanceOf(user1) - user1ReserveBefore;
        assertGt(redeemedAmount, 0, "User1 should have received reserves back");
        assertApproxEqRel(redeemedAmount, expectedRedeemAmount, 0.05e18, "Redeemed amount should match expected with 18 decimal token");
    }
